...
export async function generateMetadata() {
    await connectDB();
    const page = await WebPage.findOne({ path: "/seo-service" }).lean();
    ...
    return (
        <main className="min-h-screen bg-white dark:bg-[#020617] selection:bg-blue-500/30">
            ...
            <ContentHero bannerConfig={pageData?.content?.bannerConfig}
                ...
                highlight=""
                description=""
                bannerImage={cmsBannerImage || "/Banner/seo_service.webp"}
                highlightClass="text-blue-500 dark:text-blue-400"
            />

            <section className="py-6 md:py-8 px-4">
                <div className="max-w-6xl mx-auto">
                    <SeoContent dynamicData={pageData} />
                </div>
            </section>

            <SolutionContactForm serviceName="SEO Service" />


            <PageFAQSection pageName="seo-service" />
