...
export default async function IphoneAppsPage() {
    ...
    return (
        <main className="min-h-screen bg-white dark:bg-[#020617] selection:bg-blue-500/30">
            ...
            >
                <Image src={cmsBannerImage || pageData?.content?.heroImage || "/Banner/iphone.webp"} alt="iphone-apps-development Banner" fill className="object-cover object-center" priority sizes="(max-width: 768px) 100vw, 50vw" />
            </ContentHero>
