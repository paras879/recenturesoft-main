            ...
            <div className="container mx-auto px-4 lg:px-8 relative z-10 max-w-[1400px]">
                <div className="grid grid-cols-2 lg:grid-cols-12 gap-6 md:gap-8 lg:gap-8 mb-6 md:mb-10 lg:mb-12">
                    ...
                    <div className="col-span-2 lg:col-span-4 order-3 md:order-3 lg:order-1">
                        <Link href="/" className="inline-block mb-6">
                            <Image src="/Logo.png" alt="RecentureSoft" width={200} height={80} sizes="200px" quality={50} className="h-16 md:h-20 w-auto object-contain transition-transform duration-300 hover:scale-105 drop-shadow-sm" />
                        </Link>
                ...
                <div className="mt-0 pt-0 flex flex-col md:flex-row items-center justify-between gap-4">
                    ...
                    <div className="flex gap-6">
                        <Link href="/privacy-policy" className="text-slate-600 hover:text-slate-900 dark:text-gray-400 dark:hover:text-white text-sm font-medium transition-colors">Privacy Policy</Link>
