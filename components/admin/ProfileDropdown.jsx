        ...
        <div className="relative" ref={dropdownRef}>
            ...
            >
                <div className="flex flex-col items-end hidden sm:flex whitespace-nowrap">
                    <span className="text-sm font-semibold text-slate-900 dark:text-white group-hover:text-cyan-600 dark:group-hover:text-cyan-400 transition-colors">Admin Paras</span>
                    <span className="text-xs text-slate-500 dark:text-slate-400">Master Admin</span>
                </div>
                <div className="flex items-center gap-1">
                    <div className="w-10 h-10 bg-gradient-to-tr from-cyan-500 to-blue-500 rounded-full flex items-center justify-center text-white font-bold shadow-md shadow-cyan-500/20 group-hover:scale-105 transition-transform">
                        P
                    </div>
                ...
                {isOpen && (
                    ...
                    >
                        <div className="p-4 border-b border-slate-100 dark:border-white/5 sm:hidden">
                            <p className="text-sm font-semibold text-slate-900 dark:text-white">Admin Paras</p>
