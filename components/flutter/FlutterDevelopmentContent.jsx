            ...
            <section className="py-4 md:py-8 bg-white dark:bg-slate-900/50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center max-w-3xl mx-auto mb-6 md:mb-16">
                        <h2 className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white mb-4">Why Businesses Choose Flutter</h2>
...
<div className="mt-6 flex justify-center md:hidden w-full">
    <button onClick={() => setExpandedGrids(prev => ({...prev, 'grid20': !prev['grid20']}))} className="px-8 py-3 rounded-full border-2 border-blue-600 text-blue-600 font-bold text-sm shadow-sm active:bg-blue-50 transition-colors bg-transparent">
        {expandedGrids['grid20'] ? 'Show Less' : 'Show More'}
                        ...
                        >
                            <Image src="/images/ai-chatbot/hero_ai_chatbot.webp" alt="Flutter Cross Platform" fill sizes="(max-width: 768px) 100vw, 50vw" className="object-cover rounded-3xl shadow-xl" />
                        </motion.div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-4 md:py-8 bg-slate-50 dark:bg-[#020617]">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            <Image src="/images/ai-services/hero_ai_consulting.webp" alt="About Flutter Development" fill sizes="(max-width: 768px) 100vw, 50vw" className="object-cover rounded-[2rem] shadow-2xl" />
                        </motion.div>
                        <motion.div
                            initial={{ opacity: 0, x: 30 }}
                            whileInView={{ opacity: 1, x: 0 }}
            ...
            <section className="py-4 md:py-8 bg-white dark:bg-slate-900/30">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center max-w-3xl mx-auto mb-6 md:mb-16">
                        <h2 className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white mb-4">Our Flutter Development Services</h2>
            ...
            <section className="py-4 md:py-8 bg-white dark:bg-slate-900/50">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className={`space-y-4  md: ${expandedGrids['grid13'] ? '' : '[&>*:nth-child(n+4)]:hidden md:[&>*:nth-child(n+4)]:block'}`}>
                        {[
                            { q: "Why should I choose Flutter for mobile app development?", a: "Flutter allows you to build visually stunning, natively compiled applications for both mobile, web, and desktop from a single codebase. It significantly reduces development time and costs while providing exceptional performance." },
                            { q: "Can Flutter build Android and iOS apps together?", a: "Yes, that is the primary advantage of Flutter. By writing the code once using the Dart programming language, you can compile and deploy the exact same application to both Android and iOS devices." },
                            { q: "Is Flutter suitable for enterprise applications?", a: "Absolutely. Many global enterprises rely on Flutter for their complex applications. It offers secure architecture, scalable state management, and high-performance rendering ideal for large-scale business operations." },
                            { q: "How long does Flutter app development take?", a: "The timeline depends on the complexity of your app. However, because it uses a single codebase, Flutter development is typically 30% to 50% faster than developing separate native apps for iOS and Android." },
                            { q: "Can you migrate my existing app to Flutter?", a: "Yes, we specialize in migrating existing native applications to Flutter. We ensure a smooth transition with improved UI/UX, zero data loss, and enhanced overall performance." },
                            ...
                            { q: "Can Flutter integrate third-party APIs?", a: "Yes, Flutter seamlessly integrates with virtually any RESTful API, GraphQL endpoint, third-party service (like Stripe, Google Maps, Firebase), and custom backend architectures." },
                            { q: "How much does Flutter app development cost?", a: "Costs vary based on app complexity, features, and integration requirements. However, building with Flutter is generally much more cost-effective than native development since you only fund one development team instead of two." }
                        ].map((faq, idx) => (
                            <div
                                key={idx}
