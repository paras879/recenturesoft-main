    ...
    return (
        <div className="w-full bg-white dark:bg-[#020617] text-slate-900 dark:text-slate-100 overflow-hidden">
            ...
            <section className="py-8 relative overflow-hidden">
                ...
                <Image src="/images/rag-development/cta_rag.webp" alt="AI Office" fill sizes="(max-width: 768px) 100vw, 50vw" className="object-cover opacity-20 mix-blend-overlay z-0" />
