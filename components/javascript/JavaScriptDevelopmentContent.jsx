...
export default function JavaScriptDevelopmentContent({ faqs = [] }) {
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center mb-6 md:mb-16">
                        <div>
                            ...
                            <p className="text-base md:text-lg text-slate-600 dark:text-slate-400">
                                We specialize in building a wide range of interactive, highly responsive, and scalable enterprise applications using modern JavaScript frameworks.
                            </p>
                        </div>
            ...
            <section className="py-4 md:py-8 bg-white dark:bg-[#0b1120]">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <div className={`grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-6 ${expandedGrids['grid3'] ? '' : '[&>*:nth-child(n+7)]:hidden md:[&>*:nth-child(n+7)]:flex'}`}>
                        {['JavaScript ES6+', 'TypeScript', 'React.js', 'Next.js', 'Vue.js', 'Node.js', 'Express.js', 'Redux', 'Webpack', 'Vite', 'Firebase', 'MongoDB', 'GitHub', 'Docker'].map((tech, idx) => (
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="order-1 lg:order-2">
                            ...
                            <p className="text-base md:text-lg text-slate-600 dark:text-slate-400 mb-4 md:mb-8 leading-relaxed">
                                Partner with our professional frontend engineering team to get access to top-tier JavaScript developers who build robust and scalable systems tailored to your business needs.
                            </p>
                        </div>
                    </div>
                </div>
