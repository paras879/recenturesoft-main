    ...
    return (
        <div className="w-full bg-white dark:bg-[#020617] text-slate-900 dark:text-slate-100 overflow-hidden">
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
                        ...
                        >
                            <div className="relative w-full aspect-[4/3] md:aspect-[16/9] lg:aspect-[4/3] rounded-[30px] lg:rounded-[40px] overflow-hidden bg-gradient-to-tr from-slate-100 to-slate-50 dark:from-slate-800/40 dark:to-slate-900/40 border border-white/40 dark:border-slate-700/50 shadow-2xl flex items-center justify-center backdrop-blur-xl group">
                                ...
                                <Image src={content?.aiConsultingHero?.image || "/images/ai-services/hero_ai_consulting.webp"} alt="AI Consulting Meeting" fill sizes="(max-width: 768px) 100vw, 50vw" className="object-contain lg:object-cover z-10 transition-transform duration-700 group-hover:scale-105" priority loading="eager" />
                            </div>
                        </motion.div>
                    </div>
                </div>
            ...
            <section className="py-8 bg-white dark:bg-[#020617]">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid lg:grid-cols-12 gap-8 lg:gap-16 items-start">
                        ...
                        >
                            <Image src="/images/ai-services/case_study_healthcare.webp" alt="AI Analytics Dashboard" fill sizes="(max-width: 768px) 100vw, 50vw" className="object-cover transition-transform duration-700 hover:scale-105" />
                        </motion.div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-8 bg-slate-50 dark:bg-slate-900/30">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            <Image src="/images/ai-services/case_study_support.webp" alt="Consultant Handshake" fill sizes="(max-width: 768px) 100vw, 50vw" className="object-cover transition-transform duration-700 group-hover:scale-105" />
                        </motion.div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-8 bg-white dark:bg-[#020617]">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="space-y-4">
                        {faqs.map((faq, idx) => (
                            <div key={idx} className="bg-slate-50 dark:bg-slate-800 rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-all">
                                <button
            ...
            <section className="py-8 relative overflow-hidden">
                ...
                <Image src="/images/ai-services/case_study_document.webp" alt="AI Office" fill sizes="(max-width: 768px) 100vw, 50vw" className="object-cover opacity-20 mix-blend-overlay z-0" />
