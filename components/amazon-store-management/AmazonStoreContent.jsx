...
export default function AmazonStoreContent({ dynamicData = {} }) {
    ...
    return (
        <div className="w-full mt-4 mb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-20">
                {(amazonServices.cards?.length > 0 ? amazonServices.cards : services).map((card, index) => {
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    <div>
                        <h4 className="text-xl font-bold mb-4 text-slate-900 dark:text-white flex items-center gap-2">
                            <Lightbulb className="w-6 h-6 text-blue-500" /> {amazonProcess.step1Title || "Analysis & Roadmap"}
                        </h4>
                        ...
                        <h4 className="text-xl font-bold mb-4 text-slate-900 dark:text-white flex items-center gap-2">
                            <Rocket className="w-6 h-6 text-blue-500" /> {amazonProcess.step2Title || "Launch & Support"}
                        </h4>
                    ...
                    <div>
                        <h4 className="text-xl font-bold mb-6 text-slate-900 dark:text-white">{amazonProcess.checklistTitle || "Our Development Checklist"}</h4>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-20">
                {(amazonBenefits.cards?.length > 0 ? amazonBenefits.cards : benefits).map((card, i) => {
