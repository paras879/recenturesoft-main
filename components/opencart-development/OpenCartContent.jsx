...
export default function OpenCartContent() {
    const benefits = [
                    ...
                    <div className="space-y-6">
                        {process.map((step, i) => (
                            <div key={i} className="flex items-center gap-4">
                                ...
                                <span className="text-slate-700 dark:text-slate-300 font-medium text-lg">{step}</span>
                            </div>
                        ))}
                    </div>
                </div>
                        ...
                        {industries.map((ind, i) => {
                            ...
                            return (
                                <div key={i} className="flex items-center gap-3 p-4 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 hover:shadow-md transition-all">
                                    ...
                                    <span className="font-medium text-slate-700 dark:text-slate-300">{ind.label}</span>
                                </div>
                            );
                        })}
                    </div>
