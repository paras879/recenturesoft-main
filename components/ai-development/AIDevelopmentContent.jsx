...
const AIDevelopmentContent = ({ faqs = [], content = {} }) => {
    ...
    return (
        <div className="w-full bg-white dark:bg-[#020617] text-slate-900 dark:text-slate-100 overflow-hidden">
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
                        ...
                        >
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-medium md:font-extrabold text-slate-900 dark:text-white leading-tight mb-6 tracking-tight">
                                {content?.aiDevelopmentHero?.title || "AI Development"} <br className="hidden md:block" />
                                <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-500">
                                    {content?.aiDevelopmentHero?.titleHighlight || "Services"}
                                </span>
                            </h1>
                            <p className="text-base md:text-xl text-slate-600 dark:text-slate-300 mb-8 leading-relaxed max-w-2xl">
                                {content?.aiDevelopmentHero?.description || "Build intelligent AI-powered software solutions that automate processes, improve decision-making, and accelerate business growth with custom AI development tailored to your enterprise needs."}
                            </p>
                            <div className="flex flex-col sm:flex-row flex-wrap items-center gap-4 w-full sm:w-auto" style={{ width: "auto", height: "auto" }}>
                                <button onClick={openMeetingModal} className="w-full sm:w-auto text-center px-6 py-3 md:px-8 md:py-4 text-base md:text-lg bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 text-white rounded-full font-medium md:font-semibold text-lg transition-all shadow-lg shadow-blue-500/30 hover:shadow-blue-500/50 hover:-translate-y-1">
                                    {content?.aiDevelopmentHero?.primaryBtnText || "Get Free Consultation"}
                                </button>
                                <Link href="/contact" className="w-full sm:w-auto text-center px-6 py-3 md:px-8 md:py-4 text-base md:text-lg bg-white dark:bg-slate-800/50 text-slate-900 dark:text-white border border-slate-200 dark:border-slate-700 hover:border-blue-500 dark:hover:border-blue-500 rounded-full font-medium md:font-semibold text-lg transition-all hover:-translate-y-1 shadow-sm backdrop-blur-md">
                                    {content?.aiDevelopmentHero?.secondaryBtnText || "Talk to AI Experts"}
                                </Link>
                            </div>
                        </motion.div>
                        ...
                        >
                            <div className="relative w-full aspect-[4/3] md:aspect-[16/9] lg:aspect-[4/3] rounded-[30px] lg:rounded-[40px] overflow-hidden bg-gradient-to-tr from-slate-100 to-slate-50 dark:from-slate-800/40 dark:to-slate-900/40 border border-white/40 dark:border-slate-700/50 shadow-2xl flex items-center justify-center backdrop-blur-xl group">
                                ...
                                <Image src={content?.aiDevelopmentHero?.image || "/images/ai-development/hero_ai_development.webp"} alt="AI Developer Working" fill sizes="(max-width: 768px) 100vw, 50vw" className="object-contain lg:object-cover z-10 transition-transform duration-700 group-hover:scale-105" priority loading="eager" />
                            </div>
                        </motion.div>
                    </div>
                </div>
            ...
            <section className="py-8 bg-slate-50 dark:bg-slate-900/50 border-y border-slate-200 dark:border-slate-800">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-medium md:font-bold text-slate-900 dark:text-white mb-4">{content?.aiDevelopmentTechLogos?.title || "AI Technologies We Specialize In"}</h2>
                        <div className="w-20 h-1 bg-blue-600 mx-auto rounded-full"></div>
                    </div>

                    <div className="flex flex-wrap justify-center gap-3 md:gap-6">
                        {(content?.aiDevelopmentTechLogos?.tags?.length > 0 ? content.aiDevelopmentTechLogos.tags : ['OpenAI', 'Gemini', 'Claude', 'Microsoft Azure AI', 'AWS AI', 'Google Cloud AI', 'LangChain', 'LlamaIndex', 'Python', 'FastAPI', 'TensorFlow', 'PyTorch', 'Node.js', 'React', 'Next.js', 'Docker']).map((tech, idx) => (
                            <motion.div
                                key={idx}
            ...
            <section className="py-8 bg-white dark:bg-[#020617]">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            <Image src={content?.aiDevelopmentAbout?.image || "/images/ai-development/about_ai_development.webp"} alt="AI Agent Development" fill sizes="(max-width: 768px) 100vw, 50vw" className="object-cover transition-transform duration-700 group-hover:scale-105" />
                        </motion.div>
                        ...
                        >
                            <h2 className="text-3xl md:text-4xl font-medium md:font-bold text-slate-900 dark:text-white mb-6 leading-tight">
                                {content?.aiDevelopmentAbout?.heading || "Empowering Businesses with Custom AI"}
                            </h2>
                            <p className="text-lg text-slate-600 dark:text-slate-300 mb-10 leading-relaxed">
                                {content?.aiDevelopmentAbout?.desc1 || "At RecentureSoft, we don't just build AI; we architect intelligent systems that integrate seamlessly into your operations. From machine learning models to autonomous AI agents, we deliver secure, scalable, and high-performance solutions."}
                            </p>

                            <div className="grid grid-cols-2 gap-6">
                                {(content?.aiDevelopmentAbout?.stats?.length > 0 ? content.aiDevelopmentAbout.stats : [
            ...
            <section className="py-8 bg-slate-50 dark:bg-slate-900/30">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center max-w-3xl mx-auto mb-16">
                        <h2 className="text-3xl md:text-4xl font-medium md:font-bold text-slate-900 dark:text-white mb-4">{content?.aiDevelopmentServices?.title || "Our Core AI Services"}</h2>
                        <div className="w-20 h-1 bg-blue-600 mx-auto rounded-full mb-6"></div>
                        
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                        {(content?.aiDevelopmentServices?.cards?.length > 0 ? content.aiDevelopmentServices.cards : [
                            ...
                            { title: 'Natural Language Processing', icon: Globe, desc: 'Modernize legacy systems and integrate intelligent AI solutions.' },
                            { title: 'Computer Vision', icon: Brain, desc: 'Design custom ML models tailored to your specific industry challenges.' },
                            { title: 'Generative AI Solutions', icon: Bot, desc: 'Leverage generative models to automate content, code, and customer support.' },
                            { title: 'AI Infrastructure Setup', icon: MessageSquare, desc: 'Select and fine-tune the right Large Language Models for your data.' },
                    ...
                    <div className="grid lg:grid-cols-12 gap-8 lg:gap-16 items-start">
                        ...
                        >
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 gap-4">
                                {(content?.aiDevelopmentSolutions?.cards?.length > 0 ? content.aiDevelopmentSolutions.cards : [
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <motion.div
                            initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}
                        >
                            <h2 className="text-3xl md:text-4xl font-medium md:font-bold text-slate-900 dark:text-white mb-4">{content?.aiDevelopmentWhyChoose?.title || "Why Choose RecentureSoft"}</h2>
                            <div className="w-20 h-1 bg-blue-600 rounded-full mb-10"></div>

                            <div className="space-y-6">
                                {(content?.aiDevelopmentWhyChoose?.cards?.length > 0 ? content.aiDevelopmentWhyChoose.cards : [
            ...
            <section className="py-8 bg-white dark:bg-[#020617]">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center max-w-3xl mx-auto mb-16">
                        <h2 className="text-3xl md:text-4xl font-medium md:font-bold text-slate-900 dark:text-white mb-4">{content?.aiDevelopmentCaseStudies?.title || "Development Case Studies"}</h2>
                        <div className="w-20 h-1 bg-blue-600 mx-auto rounded-full mb-6"></div>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                        {(content?.aiDevelopmentCaseStudies?.cards?.length > 0 ? content.aiDevelopmentCaseStudies.cards : [
                            ...
                            { title: 'Retail AI Strategy', problem: 'Poor customer retention.', solution: 'Formulated an AI recommendation engine roadmap.', result: 'Sales increased by 30% in two quarters.', image: '/images/ai-development/case_study_document.webp' },
                        ]).map((caseStudy, idx) => (
                            <div key={idx} className="bg-slate-50 dark:bg-slate-800 rounded-3xl border border-slate-200 dark:border-slate-700 overflow-hidden hover:shadow-2xl transition-all group">
                                <div className="h-56 bg-slate-200 dark:bg-slate-700 relative overflow-hidden">
                                    <Image src={caseStudy.image || '/images/ai-development/case_study_document.webp'} alt={caseStudy.title} fill sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="object-cover transition-transform duration-700 group-hover:scale-110" />
            ...
            <section className="py-8 relative overflow-hidden">
                ...
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20 text-center">
                    <h2 className="text-4xl md:text-5xl font-medium md:font-extrabold text-white mb-6 leading-tight">{content?.aiDevelopmentCTA?.title || "Ready to Develop Your AI Solution?"}</h2>
                    <p className="text-xl text-blue-100 mb-10 max-w-2xl mx-auto leading-relaxed">
                        {content?.aiDevelopmentCTA?.desc || "Contact our experts and accelerate your AI journey today."}
                    </p>
                    <div className="flex flex-col sm:flex-row flex-wrap justify-center items-center gap-4 sm:gap-6">
                        <button onClick={openMeetingModal} className="w-full sm:w-auto justify-center text-center px-6 py-3 md:px-8 md:py-4 text-base md:text-lg bg-white text-blue-700 hover:bg-blue-50 rounded-full font-medium md:font-bold transition-all shadow-[0_0_40px_rgba(255,255,255,0.3)] hover:shadow-[0_0_60px_rgba(255,255,255,0.5)] hover:-translate-y-1 flex items-center gap-2">
                            {content?.aiDevelopmentCTA?.primaryBtnText || "Book Free Consultation"} <ArrowRight className="w-5 h-5" />
                        </button>
                        <Link href="/contact" className="w-full sm:w-auto text-center px-6 py-3 md:px-8 md:py-4 bg-transparent text-white border-2 border-white/30 hover:border-white rounded-full font-medium md:font-bold text-base md:text-lg transition-all hover:-translate-y-1 flex justify-center items-center">
                            {content?.aiDevelopmentCTA?.secondaryBtnText || "Contact Us"}
                        </Link>
                    </div>
                </div>
            </section>
...
export default AIDevelopmentContent;
