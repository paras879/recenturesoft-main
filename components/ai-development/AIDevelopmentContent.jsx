                    ...
                    <div className="grid lg:grid-cols-2 gap-8 lg:gap-10 items-center">
                        ...
                        >
                            <div className="relative w-full aspect-[4/3] md:aspect-[16/9] lg:aspect-[4/3] rounded-2xl overflow-hidden shadow-lg shadow-black/5 dark:shadow-black/20 group">
                                <Image src={content?.aiDevelopmentHero?.image || "/images/ai-development/hero_ai_development.webp"} alt="AI Developer Working" fill sizes="(max-width: 768px) 100vw, 50vw" className="object-cover z-10 transition-transform duration-700 group-hover:scale-105" priority loading="eager" />
                            </div>
                        </motion.div>
                    </div>
                </div>
