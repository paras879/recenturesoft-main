...
files.forEach(file => {
    ...
    if (content.includes('setActiveFaq')) {
        ...
        // Pattern 1: p-6
        newContent = newContent.replace(/className="w-full flex items-center justify-between p-6/g, 'className="w-full flex items-center justify-between px-4 py-3 md:px-6 md:py-3');
        ...
        // Pattern 2: px-6 py-5
        newContent = newContent.replace(/className="w-full px-6 py-5 flex items-center/g, 'className="w-full px-4 py-3 md:px-6 md:py-3 flex items-center');
